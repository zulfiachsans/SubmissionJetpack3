...
class AllCatalougeRepo private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteAllData: RemoteAllDataSource, localDataSource: LocalDataSource, appExecutors: AppExecutors): AllCatalougeRepo =
                instance ?: synchronized(this) {
                    instance ?: AllCatalougeRepo(remoteAllData, localDataSource, appExecutors)
                }
    }
